...
The main file, "MotorolaDisassembler.cpp" takes in a motorola s record file 
(the compiled version I include looks for a file called "6-16-06 ECU Read"), 
discards some data (I think I removed text and certain S-types), and reads in
the s record file and linearly steps through it, comparing bits to allowable
machine instructions. Every time certain types of branching commands are found,
